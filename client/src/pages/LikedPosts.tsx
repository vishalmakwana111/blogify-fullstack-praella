...
export function LikedPosts() {
  ...
  const fetchLikedPosts = async () => {
    try {
      ...
      setError(error.response?.data?.message || 'Failed to fetch liked posts');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-4 h-full flex flex-col">
      <div className="mb-4 flex-shrink-0">
        ...
        <p className="text-gray-600 mt-1">All posts you have liked will appear here.</p>
      </div>
        ...
        {likedPosts.length === 0 ? (
          ...
          <div className="bg-white rounded-lg border border-gray-200 h-full flex flex-col">
            <div className="p-3 border-b border-gray-200 flex-shrink-0">
              <h2 className="text-lg font-semibold text-gray-900">All Liked Posts</h2>
            </div>
